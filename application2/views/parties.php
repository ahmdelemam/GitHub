<img class="fill" src="<?= site_url(); ?>_/images/partiesbg.jpg" alt=" ">
<img class="t7sh" src="<?= site_url(); ?>_/images/amr-parties.png" alt=" ">
<?php require_once('menu.php'); ?>
<div><section class="container minimum">
        <article class="span5 paper pull-left"><h1> حفلات</h1>
