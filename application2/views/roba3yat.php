<img class="fill" src="<?= site_url(); ?>_/images/roba3yat/roba3yatbg.jpg" alt=" ">
<img class="t7sh" src="<?= site_url(); ?>_/images/roba3yat/amrroba3yat.png" alt=" ">
<?php require_once('menu.php'); ?>
<div><section class="container minimum">
        <article class="span5 paper pull-left " ><h1> رباعيات</h1>
...
echo '<center><h1> لا يوجد اى حفلات</h1></center>';
}else{
